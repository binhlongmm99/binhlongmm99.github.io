...
$('document').ready(function () {
	...
	$('#dj_time').click(function () {
		...
		$('#b11').animate({ top: vh - vh / 4, left: vw - vw * 3 / 5 }, 500);
		$('#b22').animate({ top: vh - vh / 4, left: vw - vw * 2 / 5 }, 500);
		$('#b33').animate({ top: vh - vh / 4, left: vw - vw * 1 / 5 }, 500);
		$('#b44').animate({ top: vh - vh / 4, left: vw }, 500); // Exact center
		$('#b55').animate({ top: vh - vh / 4, left: vw + vw * 1 / 5 }, 500);
		$('#b66').animate({ top: vh - vh / 4, left: vw + vw * 2 / 5 }, 500);
		$('#b77').animate({ top: vh - vh / 4, left: vw + vw * 3 / 5 }, 500);
